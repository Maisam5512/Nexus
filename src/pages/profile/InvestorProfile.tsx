...
//       if (response.success) {
//         const hasRequested =
//           response.requests?.some((req: any) => req.investorId === targetId && req.entrepreneurId === currentUser.id) || false
    ...
    try {
      ...
      if (checkResponse.success) {
        const hasExistingRequest = checkResponse.requests?.some((req: any) => 
          req.entrepreneurId === currentUser.id && 
          req.investorId === targetId
        )
