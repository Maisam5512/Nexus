...
//         setEntrepreneur(response.data as unknown as Entrepreneur)
//       } else {
...
//       if (response.success) {
//         const hasRequested =
//           response.requests?.some((req: any) => req.entrepreneurId === targetId && req.investorId === currentUser.id) || false
...
//         <p className="text-gray-600 mt-2">
//           This profile belongs to an investor, not an entrepreneur.
//         </p>
//         <Link to="/dashboard">
//           <Button variant="outline" className="mt-4 bg-transparent">
//             Back to Dashboard
  ...
  const handleSendRequest = async () => {
    ...
    try {
      ...
      if (checkResponse.success) {
        const hasExistingRequest = checkResponse.requests?.some((req: any) => 
          req.investorId === currentUser.id && 
          req.entrepreneurId === targetId
        )
